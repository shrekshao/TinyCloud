...
class Log : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:backend.Log) */ {
 public:
  Log();
  virtual ~Log();
  ...
  // @@protoc_insertion_point(class_scope:backend.Log)
 private:
...
inline void Log::set_data(const void* value, size_t size) {
